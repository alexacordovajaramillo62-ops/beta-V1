...
local AUTOKICK_SCANNER_ACTIVE = false

local function setupAutokick()
    if not CONFIG.AUTOKICK_ENABLED then
        -- Limpiar conexiones si está desactivado
        for _, conn in ipairs(autokickConnections) do
            conn:Disconnect()
        end
        autokickConnections = {}
        AUTOKICK_SCANNER_ACTIVE = false
        return
    end
    
    if AUTOKICK_SCANNER_ACTIVE then return end
    AUTOKICK_SCANNER_ACTIVE = true
    
    local KEYWORD = CONFIG.AUTOKICK_KEYWORD:lower()
    local KICK_MESSAGE = CONFIG.AUTOKICK_MESSAGE
    ...
    -- Escuchar nuevos GUIs
    local conn = PlayerGui.ChildAdded:Connect(function(gui)
        watchGui(gui)
    end)
    table.insert(autokickConnections, conn)
    
    -- También escanear ScreenGui principal
    if screenGui and screenGui:IsA("ScreenGui") then
        watchGui(screenGui)
    end
    
    showNotification("Autokick Enabled - Watching for: '" .. CONFIG.AUTOKICK_KEYWORD .. "'", COLORS.Red)
end
...
getgenv().BRAINROT_CONFIG = {
    ...
    AUTOKICK_KEYWORD       = "you stole",
    AUTOKICK_MESSAGE       = "https://discord.gg/5PnYundM",
...
local COLORS = {
    ...
    Surface                = Color3.fromRGB(20, 10, 8),
    SurfaceTransparency    = 0.20,
    Text    = Color3.fromRGB(255, 220, 200),
    TextDim = Color3.fromRGB(240, 200, 180),
    Accent  = Color3.new(1.000000, 0.549020, 0.000000),
    Purple = Color3.new(1.000000, 0.400000, 0.000000),
    Pink   = Color3.fromRGB(255, 120, 80),
    Cyan   = Color3.fromRGB(255, 180, 100),
    Yellow = Color3.fromRGB(255, 200, 120),
    Blue   = Color3.fromRGB(255, 140, 90),
    Red    = Color3.fromRGB(255, 80, 60),
    Success = Color3.fromRGB(255, 180, 80),
    Warning = Color3.fromRGB(255, 150, 70),
...
local PLAYER_OUTLINE_MAIN = Color3.fromRGB(255, 140, 80)
local PLAYER_OUTLINE_SOFT = Color3.new(1.000000, 0.400000, 0.000000)
...
local function makeTextGlow(textElement, color1, color2, duration, delay)
    ...
    color2 = color2 or Color3.fromRGB(255, 100, 80)
    ...
    task.spawn(function()
        ...
        while textElement and textElement.Parent do
...
local function addTextGradient(textElement, color1, color2, rotation)
    ...
    task.spawn(function()
        while textElement and textElement.Parent and gradient and gradient.Parent do
            for rot = rotation, rotation + 360, 2 do
                if not (textElement and textElement.Parent and gradient and gradient.Parent) then 
                    break 
                end
...
local NOTIFICATION_TYPES = {
    success = {
        ...
        gradient = Color3.fromRGB(255, 180, 80)
    },
    error = {
        icon = "✗",
        color = COLORS.Error,
        gradient = Color3.fromRGB(255, 90, 70)
    },
    warning = {
        icon = "⚠",
        color = COLORS.Warning,
        gradient = Color3.fromRGB(255, 150, 70)
    },
    info = {
        icon = "ℹ",
        color = COLORS.Cyan,
        gradient = Color3.fromRGB(255, 180, 100)
    },
    default = {
        icon = "•",
        color = COLORS.Accent,
...
function showNotification(message, color, duration)
    ...
    makeTextGlow(icon, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(icon, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(messageLabel, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(messageLabel, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(closeButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(closeButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    local targetY = -100 - (#NOTIFICATION_ACTIVE - 1) * 85

    tween(notif.frame, tweenInfoMedium, {
        Position = UDim2.new(1, -1600, 1, targetY),
        BackgroundTransparency = 0.15
    })
...
local function createDesyncIndicator()
    ...
    local gradient = createElement("UIGradient", {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 140, 80)),
    ...
    local icon = createElement("TextLabel", {
        ...
        BackgroundTransparency = 1,
        Text = "PHOENIX",
        TextColor3 = Color3.fromRGB(255, 140, 80),
        TextSize = 22,
        Font = Enum.Font.GothamBold,
        Parent = indicator,
        ZIndex = 999999999999999,
    ...
    makeTextGlow(title, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(title, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(status, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(status, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
        ...
        if (animalData.uid == ESP_BEST_UID) or (animalData.genValue >= 50000000) then
            ...
            if not model then
                ...
                if not rec or rec.part ~= model then
                    ...
                    highlight.FillColor = Color3.fromRGB(255, 140, 80)
                    ...
                    bgFrame.BackgroundColor3 = Color3.fromRGB(150, 70, 30)
                    ...
                    makeTextGlow(nameLabel, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
                    addTextGradient(nameLabel, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createPlayerESP(plr)
    ...
    nameLabel.BackgroundTransparency = 1
    nameLabel.TextColor3 = Color3.fromRGB(255, 180, 100)
    nameLabel.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
function UNLOCK_BASE.CreateGUI()
    ...
    local function createNumberButton(number, yPos)
        ...
        makeTextGlow(btn, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
        addTextGradient(btn, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createToggleButton(parent, text, isEnabled, yPos, callback)
    ...
    makeTextGlow(text, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(text, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(toggleBg, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(toggleBg, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createKeybindButton(parent, text, currentKey, yPos, callback)
    ...
    makeTextGlow(keyButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(keyButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createActionButton(parent, text, buttonText, buttonColor, yPos, callback)
    ...
    makeTextGlow(actionButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(actionButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createAnimalEntry(animalData, parent)
    ...
    makeTextGlow(name, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(name, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(tpButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(tpButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(favButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(favButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createAnimalsTab(parent)
    ...
    makeTextGlow(searchBox, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(searchBox, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createFavoritesTab(parent)
    ...
    makeTextGlow(info, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(info, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(addInput, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(addInput, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(addButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(addButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(upButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(upButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(downButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(downButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(removeButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(removeButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(apply, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(apply, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(toggleCircle, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(toggleCircle, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    applyTitanzButtonStyle(toggleCircle)
    applyTitanzTextStyle(toggleCircle)
    createElement("UICorner", {
        CornerRadius = UDim.new(1, 0),
...
local function createActionsTab(parent)
    ...
    createToggleButton(scroll, "Autokick on 'you stole'", CONFIG.AUTOKICK_ENABLED, 0, function()
        CONFIG.AUTOKICK_ENABLED = not CONFIG.AUTOKICK_ENABLED
        saveConfig()
        
        if CONFIG.AUTOKICK_ENABLED then
            setupAutokick()
            showNotification("Autokick Enabled - Will kick if text contains: '" .. CONFIG.AUTOKICK_KEYWORD .. "'", COLORS.Red)
        else
            setupAutokick() -- Esto limpiará las conexiones
            showNotification("Autokick Disabled", COLORS.Cyan)
        end
        
        return CONFIG.AUTOKICK_ENABLED
    end).LayoutOrder = nextOrder()
...
local function createGui()
    ...
    applyTitanzTextStyle(title)
    makeTextGlow(title, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 120, 80), 1.2, 0)
    addTextGradient(title, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45)    
    ...
    makeTextGlow(sub, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(sub, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45)    
    ...
    if isMobile or isTablet then
        ...
        makeTextGlow(toggleButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
        addTextGradient(toggleButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
    ...
    makeTextGlow(mainTitle, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(mainTitle, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45)  

    local mainSub = createElement("TextLabel", {
        Size = UDim2.new(1, -60, 0, 18),
        Position = UDim2.new(0, 15, 0, 35),
        BackgroundTransparency = 1,
        Text = "by phoenix-finder--LK | https://discord.gg/AgPFyWkFdS",
        TextColor3 = COLORS.Pink,
    ...
    makeTextGlow(mainSub, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
    addTextGradient(mainSub, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45)  
    ...
    local tabButtons = {}
    local tabNames = { "Brainrots", "Priority", "Actions", "Stats" }
    ...
    for i, tabName in ipairs(tabNames) do
        ...
        makeTextGlow(tabButton, Color3.fromRGB(255, 140, 80), Color3.fromRGB(255, 200, 120), 1.2, 0.3)
        addTextGradient(tabButton, Color3.new(1.000000, 0.549020, 0.000000), Color3.fromRGB(255, 120, 80), 45) 
...
local function createMiniGui()
    if screenGui and screenGui:FindFirstChild("MiniGuiContainer") then
    ...
    if CONFIG.MINI_GUI_POSITION_X and CONFIG.MINI_GUI_POSITION_Y then
        ...
        defaultPos = UDim2.new(1, -180, 0, 100)
    end
    ...
    applyTitanzButtonStyle(toggleButton)
    applyTitanzTextStyle(toggleButton)
    
    toggleButton.MouseEnter:Connect(function()
        tween(toggleButton, tweenInfoFast, {
            BackgroundTransparency = 0.1,
    ...
    toggleButton.MouseButton1Click:Connect(function()
        toggleGui()
        toggleButton.Text = guiVisible and "OCULTAR GUI" or "PHOENIX GUI"
    end)
...
pcall(loadConfig)
pcall(loadFavorites)
print("[Config] Loaded GUI_POSITION_X:", CONFIG.GUI_POSITION_X, "GUI_POSITION_Y:", CONFIG.GUI_POSITION_Y)
...
task.spawn(function()
    ...
    if CONFIG.AUTOKICK_ENABLED then
        task.wait(2) -- Esperar un poco para que todo cargue
        setupAutokick()
    end
end)
